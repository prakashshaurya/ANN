# -*- coding: utf-8 -*-
"""
Created on Tue Jul 26 22:05:28 2022
...
def backward_propagation(X,Y,cache) :
    ...
    gradients ={"W1":W1,"b1":b1,"z1":z1,"a1":a1,
...
def predict(X,y,parameters) :
   ...
   """
   m= X.shape[1]
   p = np.zeros((1,m), dtype = np.int) #any zero vector
   
   # Forward propagation
   a3, caches = forward_propagation(X, parameters)
   
   #last layer is sigmoid whci outouts probability 
   #convert this probability to 0/1
   for i in (0,a3.shape[0,1]) :
       if (a3[0,i] >0.5):
           p[0,i]=1
       else:
            p[0,i]=0
